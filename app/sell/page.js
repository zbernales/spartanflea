...
export default function Sell(){
    ...
    if (loggedIn) {
        ...
        return (
            <div>
                <p><Link href="/login" className="text-blue-500 hover:text-blue-700">Log in </Link>to sell products or <Link href="/" className="text-blue-500 hover:text-blue-700">return to home</Link></p>
            </div>
        );
    }
}